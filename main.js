async function translate(text, from, to, options) {
    ...
    form.append("sign", CryptoJS.MD5(`client=fanyideskweb&mysticTime=${mysticTime}&product=webfanyi&key=ZNDFFlnzYeC5tmXSaMzeTtQAkNYYo7D2`).toString(CryptoJS.enc.Hex));
